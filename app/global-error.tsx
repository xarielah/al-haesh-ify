        ...
        <div className="flex flex-col items-center justify-center h-full p-4">
            <div className="max-w-md w-full mx-auto text-center space-y-8">
                    ...
                    <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center opacity-10">
                        {mounted && (
                            <div className="glitch-container">
                                <div className="glitch-text" data-text="404">500</div>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <h2 className="text-2xl font-bold">בעיה כללית</h2>
                    <p className="text-gray-400">
                        העמוד שניסיתם לנווט אליו מייצר שגיאה או שהמשאב בעייתי, בכל מקרה - לא בעיה שלכם. בינתיים תוכלו לחזור אחורנית מהיכן שהגעתם ולהמשיך ביומכם..
                    </p>
                </div>
